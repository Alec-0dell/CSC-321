...
def main():
    ...
    Alice_private, Alice_public, q = diffie_hellman_protocol(23, 5)
    Bob_private, Bob_public, q = diffie_hellman_protocol(23, 5)
    iv =  os.urandom(16)
    ...
    Bob_secret_key, Alice_secret_key, Mallory_secret_key = mitm_key_fixing_attack(q, Mallory_public_key_Bob, Bob_private, Alice_private)
...
def mitm_generator_attack(q, alpha):
    ...
    Mallory_secret_key = compute_shared_secret(Mallory_public_key_Bob, random.randint(10, 1000), q)
